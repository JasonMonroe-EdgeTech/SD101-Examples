window.onload = function() {
    ...
    document.getElementById('txtCardNumber').addEventListener('textInput', ccInputMask);
    document.getElementById('txtPhoneNumber').addEventListener('textInput', phoneInputMask);
